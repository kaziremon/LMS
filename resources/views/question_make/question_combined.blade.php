...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="d-inline p-2  text-dark" style="font-size: 26px;font-weight: bold">Combained Question Create</div>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-x-12 col-sm-12">
                <form action="{{route('question.combained_store')}}" method="POST">
                    @csrf
                    ...
                    <div id="sub-container">
                        <div class="subcontainer-item">
                         <div class="row">
                            <div class="col-md-6 col-sm-6 col-x-6">
                                <div class="form-group">
                                    <label class="control-label" for="state_0">Question</label>
                                    <textarea id="summernote" class="form-control" name="mc_question[]" id="" cols="30" rows="3" required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="mark">Mark</label>
                                    <input type="number" class="form-control" name="mc_mark[]" required>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="difficult_level">Question Difficult Level</label>
                                    <select name="mcq_defficult_level[]" class="form-control @error('defficult_level') is-invalid @enderror" required>
                                        <option>Select Difficult Leval</option>
                                        <option value="Easy">Easy</option>
                                        <option value="Medium">Medium</option>
                                        <option value="Hard">Hard</option>
                            ...
                            <div class="col-md-6 col-sm-6 col-x-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="option1[]">
                                </div>
                                <div class="form-group">
                                    <label for="option1">Option 2</label>
                                    <input type="text" class="form-control" placeholder="" name="option2[]">
                                </div>
                                <div class="form-group">
                                    <label for="option1">Option 3</label>
                                    <input type="text" class="form-control" placeholder="" name="option3[]">
                                </div>
                                <div class="form-group">
                                    <label for="option1">Option 4</label>
                                    <input type="text" class="form-control" placeholder="" name="option4[]">
                                </div>
                            </div>
                         </div>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div>
                                        <a href="javascript:void(0)" class="subremove-item btn btn-sm btn-danger remove-social-media">Remove</a>
                                    </div>
                                </div>
                                <br><br>
                            </div>
                    ...
                    <div class="">
                        <div>
                            <a class="btn btn-success btn-sm" id="add-option" href="javascript:;" role="button"><i class="fa fa-plus"></i> Add More Row</a>
...
<script>
    $("a#add-option").cloneData({
        mainContainerId: "sub-container", // Main container Should be ID
        cloneContainer: "subcontainer-item", // Which you want to clone
        removeButtonClass: "subremove-item", // Remove button for remove cloned HTML
        removeConfirm: true, // default true confirm before delete clone item
        removeConfirmMessage: "Are you sure want to delete?", // confirm delete message
        //append: '<a href="javascript:void(0)" class="remove-item btn btn-sm btn-danger remove-social-media">Remove</a>', // Set extra HTML append to clone HTML
        minLimit: 1, // Default 1 set minimum clone HTML required
