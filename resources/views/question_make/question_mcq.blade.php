...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="d-inline p-2  text-dark" style="font-size: 26px;font-weight: bold">MCQ Question Create</div>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-x-12 col-sm-12">
                <form action="{{route('question.mcq_store')}}" method="POST">
                    @csrf
                         ...
                         <div class="row">
                            <div class="col-md-6 col-sm-6 col-x-6">
                                <div class="form-group">
                                    ...
                                    <textarea id="summernote" class="form-control" name="question[]" id="" cols="30" rows="3" required></textarea>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                   ...
                                   <select name="correct[]" id="" class="form-control" required>
                            ...
                            <div class="col-md-6 col-sm-6 col-x-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="option1[]" required>
                                </div>
                                <div class="form-group">
                                    <label for="option1">Option 2</label>
                                    <input type="text" class="form-control" placeholder="" name="option2[]" required>
                                </div>
                                <div class="form-group">
