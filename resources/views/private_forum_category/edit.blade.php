    ...
    <div class="container-fluid">
        <div class="row mb-2">
            ...
            <div class="col-sm-4">
                ...
                <div class="d-inline p-2 text-white text-right">
                    <a href="{{ route('private_category.create') }}" class="btn btn-sm btn-primary text-right"><i class="fas fa-plus"></i> Create</a>
                </div>
                @endcan
            </div>
            <!-- /.col -->
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-12 col-x-12 col-sm-12">
                <form action="{{route('private_category.update',$forumcategory->id) }}" method="POST">
                    @csrf
                    @method('PUT')
