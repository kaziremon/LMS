...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <div class="d-inline p-2  text-dark" style="font-size: 26px;font-weight: bold">Batch</div>
            </div>
            <!-- /.col -->
            <div class="col-sm-6">
               ...
               <table  id="dataTableHover" class="table align-items-center table-flush table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                @can('batch.edit')
                                <a href="{{ route('batch.edit',$batch->id) }}" class="btn btn-sm btn-success m-1"><i class="fas fa-edit"></i> Edit</a>
                                @endcan
                                @can('batch.destroy')
                                <button type="submit" class="btn btn-danger btn-sm m-1" onclick="deleteCategory({{ $batch->id }})"><i class="fas fa-trash"></i> DELETE</button>
